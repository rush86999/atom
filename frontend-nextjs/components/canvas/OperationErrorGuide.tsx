...
export const OperationErrorGuide: React.FC<OperationErrorGuideProps> = ({
  ...
  return (
    <>
      ...
      <div className={`operation-error-guide bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 border-l-4 border-red-500 ${className}`}>
        {/* Error Header */}
        <div className="flex items-start space-x-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">{errorData.error.message}</p>
        ...
        <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">📊 Agent Analysis</h4>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-gray-900 dark:text-gray-100">{errorData.agent_analysis.what_happened}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-900 dark:text-gray-100">{errorData.agent_analysis.why_it_happened}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-900 dark:text-gray-100">{errorData.agent_analysis.impact}</p>
            </div>
          </div>
        </div>
        ...
        {/* Resolutions */}
        <div>
          <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">🔧 Suggested Resolutions</h4>
          ...
          <div className="space-y-3">
            {errorData.resolutions.map((resolution, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`border rounded-lg overflow-hidden transition-all ${isSuggested ? 'border-blue-500 bg-blue-50' : 'border-gray-200 dark:border-gray-700'
                ...
                >
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="font-medium text-gray-900 dark:text-gray-100">{resolution.title}</span>
                    </div>
                  ...
                  {isExpanded && (
                    <div className="p-4 pt-0 border-t">
                      <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">{resolution.description}</p>
                      ...
                      <div className="mb-4">
                        ...
                        <ol className="text-sm text-gray-900 dark:text-gray-100 space-y-1">
                          {resolution.steps.map((step, stepIndex) => (
                            <li key={stepIndex} className="flex items-start">
                              <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs rounded-full mr-2 mt-0.5">
                                {stepIndex + 1}
                              </span>
                              <span>{step}</span>
                            </li>
        ...
        <details className="mt-6">
          <summary className="cursor-pointer text-sm text-gray-600 hover:text-gray-900 dark:text-gray-100">
