...
const ServiceManagement: React.FC = () => {
  ...
  const mockServices: Service[] = [
    ...
    },
    {
      ...
      status: "connected",
      type: "integration",
      description: "Figma design collaboration and file management",
      capabilities: [
        "browse_files",
        "manage_teams",
        "access_components",
      ...
      health: "healthy",
      last_checked: new Date().toISOString(),
      oauth_url: "/api/auth/figma/authorize",
    },
    {
      id: "shopify",
      name: "Shopify",
      status: "connected",
      type: "integration",
      description: "Shopify e-commerce and store management",
      capabilities: [
        "manage_products",
        "process_orders",
        "customer_management",
      ...
      health: "healthy",
      last_checked: new Date().toISOString(),
      oauth_url: "/api/auth/shopify/authorize",
    },
    {
      id: "stripe",
      name: "Stripe",
    ...
    },
    {
      ...
      health: "healthy",
      last_checked: new Date().toISOString(),
      oauth_url: "/api/auth/linear/authorize",
    },
    {
      id: "outlook",
      name: "Outlook",
      ...
      health: "healthy",
      last_checked: new Date().toISOString(),
      oauth_url: "/api/auth/outlook/authorize",
    },
    {
      id: "asana",
      name: "Asana",
      ...
      health: "healthy",
      last_checked: new Date().toISOString(),
      oauth_url: "/api/auth/asana/authorize",
    },
    {
      id: "notifications",
      name: "Notifications",
  ...
  const mockConnections: ServiceConnection[] = [
    ...
    },
    {
      ...
      status: "active",
      connected_at: "2025-10-04T11:20:00Z",
      last_sync: new Date().toISOString(),
      sync_status: "success",
      error_count: 0,
    },
    {
      ...
      name: "Shopify Store",
      status: "active",
      connected_at: "2025-10-05T09:30:00Z",
      last_sync: new Date().toISOString(),
      sync_status: "success",
      error_count: 0,
    },
