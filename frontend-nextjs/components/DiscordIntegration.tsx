                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-4">
                        <div className="p-2 rounded-lg" style={{ backgroundColor: DISCORD_COLOR }}>
                            <svg className="w-10 h-10 text-gray-900 dark:text-white" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Discord Integration</h1>
                                ...
                                <CardHeader>
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-gray-600 dark:text-gray-400">#{integrationData.profile.discriminator}</p>
