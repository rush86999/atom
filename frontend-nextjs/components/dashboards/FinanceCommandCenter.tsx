                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <Card className="bg-black/5 dark:bg-black/40 border-black/5 dark:border-white/5 backdrop-blur-xl">
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold text-gray-900 dark:text-white flex gap-2">
                        ...
                        {/* Transactions List */}
                        <Card className="bg-black/5 dark:bg-black/40 border-black/5 dark:border-white/5 backdrop-blur-xl overflow-hidden min-h-[400px]">
                            <CardHeader>
                                <CardTitle className="text-sm font-medium text-muted-foreground uppercase">Recent Transactions</CardTitle>
                            </CardHeader>
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm text-left">
                                    <thead className="bg-black/5 dark:bg-white/5 text-muted-foreground text-xs uppercase">
                                        <tr>
                                        ...
                                        {isLoading ? (
                                            Array.from({ length: 5 }).map((_, i) => (
                                                <tr key={i} className="animate-pulse">
                                                    <td colSpan={6} className="px-6 py-4 h-12 bg-black/2 dark:bg-white/2" />
                                                </tr>
                                            ))
                                            ...
                                            transactions.filter(tx => tx.description.toLowerCase().includes(searchQuery.toLowerCase())).map((tx) => (
                                                <tr key={tx.id} className="hover:bg-black/5 dark:hover:bg-black/5 dark:bg-white/5 transition-colors group">
