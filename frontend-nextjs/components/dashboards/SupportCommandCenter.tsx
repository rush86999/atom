                            ...
                            <Card className="bg-black/40 border-white/5 backdrop-blur-xl">
                                <CardHeader className="border-b border-white/5">
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-1">Acme Corp • Assigned to Rushi Parikh</p>
                                        </div>
                                ...
                                <CardContent className="py-6 space-y-6 h-[300px] overflow-y-auto">
                                    ...
                                    <div className="flex gap-4 flex-row-reverse">
                                        <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-xs font-bold shrink-0 text-primary-foreground">RP</div>
                                        <div className="space-y-1 text-right">
                                            <div className="flex flex-row-reverse items-center gap-2">
                                                <span className="text-sm font-semibold text-white">Rushi Parikh (You)</span>
