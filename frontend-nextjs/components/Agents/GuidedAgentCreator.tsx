        ...
        {!result ? (
          ...
          <>
            ...
            <div className="py-2 text-sm text-gray-600 dark:text-gray-300" data-testid="guided-pending">
              ...
              <p className="mt-2">You can review it on the <Link href="/approvals" className="text-sky-500 hover:underline">Approvals page</Link> (a supervisor with team_lead or higher decides). Nothing was created yet.</p>
            </div>
            <DialogFooter>
