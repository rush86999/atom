            ...
            <Card className="w-full max-w-md">
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <ol className="mt-2 space-y-2 text-sm text-gray-600 dark:text-gray-400 list-decimal list-inside">
                    ...
                    <div className="pt-4 border-t text-center">
                        <Link
                            href="/auth/signin"
                            className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-100"
                        >
                            ← Back to Sign In
                        </Link>
                    </div>
