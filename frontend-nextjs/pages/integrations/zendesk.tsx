  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Complete customer support and ticketing management through Zendesk integration"
        />
        ...
        <meta
          property="og:image"
          content="/images/integrations/zendesk-og.jpg"
        />
        ...
        <meta
          name="twitter:image"
          content="/images/integrations/zendesk-twitter.jpg"
        />
      ...
      >
        ...
        <div style={{ padding: "2rem", textAlign: "center" }}>
          ...
          <p style={{ color: "#6B7280" }}>
            Zendesk integration is temporarily unavailable. Please check back
            later.
          </p>
        </div>
      </Layout>
...
export const getServerSideProps: GetServerSideProps<ZendeskPageProps> = async ({
  req,
}) => {
  // Get initial configuration from server-side
  const initialConfig = {
    environment:
      (process.env.ZENDESK_ENVIRONMENT as "production" | "sandbox") ||
      "production",
  };
