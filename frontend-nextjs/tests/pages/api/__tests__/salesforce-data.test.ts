...
import accountsHandler from "@/pages/api/integrations/salesforce/accounts";
import contactsHandler from "@/pages/api/integrations/salesforce/contacts";
import leadsHandler from "@/pages/api/integrations/salesforce/leads";
import opportunitiesHandler from "@/pages/api/integrations/salesforce/opportunities";
  ...
  describe(describeName, () => {
    ...
    it("proxies a plain GET list request to the backend", async () => {
      mockFetch.mockResolvedValue(
        jsonResponse(true, 200, { records: [{ Id: "SF-1" }] }),
      );
...
runProxySuite(
  "pages/api/integrations/salesforce/accounts",
  accountsHandler,
  "/api/salesforce/accounts",
  "Failed to fetch Salesforce accounts",
);

runProxySuite(
  "pages/api/integrations/salesforce/contacts",
  contactsHandler,
  "/api/salesforce/contacts",
  "Failed to fetch Salesforce contacts",
);

runProxySuite(
  "pages/api/integrations/salesforce/leads",
  leadsHandler,
...
runProxySuite(
  "pages/api/integrations/salesforce/opportunities",
  opportunitiesHandler,
  "/api/salesforce/opportunities",
  "Failed to fetch Salesforce opportunities",
);
