...
type: execute
wave: 2
depends_on: ["10-fix-tests-01", "10-fix-tests-02", "10-fix-tests-03", "10-fix-tests-04"]
files_modified:
...
<task type="auto">
  ...
  <files>.planning/phases/10-fix-tests/10-fix-tests-05-SUMMARY.md</files>
  <action>
...
4. **Test Suite Health**: Overall assessment (HEALTHY/NEEDS ATTENTION)
  ...
  <verify>
cat .planning/phases/10-fix-tests/10-fix-tests-05-SUMMARY.md | grep -E "Execution Time|Flakiness|HEALTHY"
...
<output>
After completion, `.planning/phases/10-fix-tests/10-fix-tests-05-SUMMARY.md` contains:
