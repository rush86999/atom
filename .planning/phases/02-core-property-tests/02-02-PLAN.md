...
must_haves:
  truths:
    - Time gaps exceeding threshold trigger new episode (boundary is exclusive: 4:00:00 does NOT trigger, 4:00:01 DOES)
    - Episode retrieval returns relevant episodes sorted by similarity score
    - Graduation readiness scores always stay in [0, 100] range
