...
**Plans**: 3 plans
- [ ] 03-social-layer-01-PLAN.md — SocialFeedService implementation (Redis pub/sub, WebSocket, dashboard UI)
- [ ] 03-social-layer-02-PLAN.md — SocialPostGenerator (GPT-4.1 mini, prompt engineering, post templates)
- [ ] 03-social-layer-03-PLAN.md — PII redaction & privacy controls (Presidio, visibility rules, audit logging)
