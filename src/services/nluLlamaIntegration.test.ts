...
describe('NLU Llama.cpp Integration', () => {
  ...
  describe('Complexity-based Routing', () => {
    ...
    it('should route very complex messages to cloud AI instead of llama.cpp', async () => {
      const complexMessage = 'Analyze my Q3 financial reports and compare them with last year\'s performance, then create a summary presentation with recommendations for next quarter';
      ...
      mockOpenAIService.generate.mockResolvedValue({
        ...
        parameters: {},
        requiresConfirmation: true,
        suggestedResponses: ['I\'ll analyze your Q3 reports and create a comparison presentation.'],
      });
