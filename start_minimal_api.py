...
def create_minimal_app():
    ...
    def test_lancedb():
        try:
            from lancedb_handler import get_lancedb_connection, create_generic_document_tables_if_not_exist
            import asyncio
            ...
            async def test():
                ...
                if db_conn:
                    ...
                    return {"status": "success", "lancedb_available": True, "tables_created": tables_created}
