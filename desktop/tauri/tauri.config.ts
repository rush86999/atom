...
+      longDescription: 'Build modern Next.js applications entirely through conversation. No local development setup required - everything happens in the cloud with real-time preview.',
+      icon: [
+        'icons/32x32.png',
+        'icons/128x128.png',
...
+      active: true,
+      endpoints: [
+        'https://release.atomai.com/web-studio/latest.json'
+      ],
+      dialog: true
+    },
+    windows: [{
