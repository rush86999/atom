/**
 * Shared Cross-Platform Property Invariants (Mobile)
 *
 * Tests shared property test invariants across all platforms.
 * Imports all properties from shared/property-tests (via SYMLINK to frontend-nextjs/shared/property-tests).
 *
