...
def create_minimal_app():
    ...
    if HAS_REAL_SERVICES:
        ...
        logger.warning("Running with fallback mock endpoints - install required services")
    ...
    def dashboard():
        ...
        try:
            ...
            dashboard_data = {
                "calendar": _get_calendar_events(user_id, start_date, end_date, api_keys),
    ...
    def _extract_api_keys_from_request(req):
        ...
        api_key_headers = {
            ...
            'X-Notion-API-Token': 'notion_api_token',
    ...
    def _get_calendar_events(user_id: str, start_date: datetime, end_date: datetime, api_keys: Dict) -> List[Dict]:
        ...
        try:
            ...
            for key_name, key_value in api_keys.items():
                ...
                validation_results[key_name] = {
                    "valid": is_valid,
                    "message": "Valid API key" if is_valid else "Invalid API key format"
                }
    ...
    def root():
        return jsonify({
            ...
            "api_key_headers": {
                ...
                "X-Notion-API-Token": "Notion API Token",
