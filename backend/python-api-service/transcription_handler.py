...
async def transcribe_audio():
    ...
    try:
        ...
        if transcription_result['success']:
            summary_result = await transcription_service.generate_meeting_summary(
            ...
            await _store_transcription(meeting_id, result)
...
async def get_meeting_transcription(meeting_id):
    ...
    try:
        ...
        results = await execute_query(query, (meeting_id,))
...
async def _store_transcription(meeting_id: str, transcription_data: Dict[str, Any]):
    """Store transcription in database"""
    try:
        query = """
