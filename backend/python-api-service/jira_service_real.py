    ...
    def update_issue(
        ...
        **kwargs
        ...
        try:
            ...
            return {"status": "success", "data": {"message": "Issue updated successfully"}}
...
def get_real_jira_client(server: str, username: str = None, password: str = None, token: str = None) -> JIRA:
