...
class ConditionMonitorType(Base):
    """
    Condition monitor type definitions.

    Stub model for Phase 265 to unblock tests.
    TODO: Implement full schema for condition monitor types.
    """
    __tablename__ = "condition_monitor_types"
