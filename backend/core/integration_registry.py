...
DEFAULT_SERVICE_REGISTRY = {
    ...
    "whatsapp": "integrations.whatsapp_business_integration:WhatsAppBusinessIntegration",
    ...
    # Adapter-backed connectors. The *_service modules for these never existed
    # (phantom mappings silently failed to load and poisoned the catalog); the
    # real classes live in core/integrations/adapters/.
    "stripe": "core.integrations.adapters.stripe:StripeAdapter",
    "clickup": "core.integrations.adapters.clickup:ClickUpAdapter",
    "gotomeeting": "core.integrations.adapters.gotomeeting:GotoMeetingAdapter",
    "apollo": "core.integrations.adapters.apollo:ApolloAdapter",
}
