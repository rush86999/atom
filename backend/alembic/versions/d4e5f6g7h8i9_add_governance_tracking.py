...
def upgrade():
    # First, create the agent_executions table if it doesn't exist
    # (This table is defined in models.py but was never migrated)
    op.create_table(
        'agent_executions',
...
def downgrade():
    ...
    # ### Drop agent_executions indexes and table ###
    try:
