...
def downgrade() -> None:
    """Remove package_registry table and package_id foreign key from skill_executions."""

    # Drop package_id foreign key from skill_executions
    op.drop_index('ix_skill_executions_package_id', table_name='skill_executions')
    op.drop_constraint('fk_skill_executions_package', 'skill_executions', type_='foreignkey')
    op.drop_column('skill_executions', 'package_id')
