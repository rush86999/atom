...
async def shopify_order_created(
    ...
    workspace_id = "default" # In production, map shop_domain -> workspace_id
    # TODO: Lookup workspace by shop_domain
    ...
    order = EcommerceOrder(
        ...
        total_shipping=float(payload.get("total_shipping_line_price", 0.0) if "total_shipping_line_price" in payload else 0.0),
