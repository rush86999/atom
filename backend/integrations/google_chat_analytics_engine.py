...
class GoogleChatAnalyticsEngine:
            ...
            if format.lower() == 'csv':
                ...
                if excel_data:
                    return {
                        ...
                        'format': 'excel',
                        'data': excel_data,
                        'filename': f"google_chat_{metric.value}_{time_range.value}.xlsx"
                    }
                else:
                    return {
                        'ok': False,
    ...
    def _convert_to_excel(self, data_points: List[GoogleChatAnalyticsDataPoint],
                         metric: GoogleChatAnalyticsMetric,
                         time_range: GoogleChatAnalyticsTimeRange) -> Optional[bytes]:
        ...
        try:
            ...
            # Metadata data
            metadata_info = [
                ('Engine', 'Google Chat Analytics Engine'),
                ('Version', '3.0.0'),
