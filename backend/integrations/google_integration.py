...
class GoogleIntegration:
    def __init__(self):
        ...
        self.api_endpoint = 'https://www.googleapis.com'
    ...
    def get_headers(self) -> Dict[str, str]:
        ...
        if self.access_token:
            ...
            elif 'google' in ['slack', 'teams', 'outlook']:
    ...
    def _get_user_endpoint(self) -> str:
        ...
        return f"{base_url}{endpoints.get('google', '/me')}"
    ...
    def _get_list_endpoint(self) -> str:
        ...
        base_url = self.api_endpoint
        if 'google' in ['teams', 'outlook']:
            base_url = 'https://graph.microsoft.com'
        return f"{base_url}{endpoints.get('google', '/items')}"
