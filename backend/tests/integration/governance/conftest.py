"""
Fixtures for integration tests in governance directory.

Provides database session and common test data with all governance tables.
"""
...
def db_session():
    ...
    Uses individual table creation to handle duplicate index errors.
    """
    ...
    print(f"\n[DEBUG] Integration DB: Created {created_count} tables, skipped {skipped_count} with errors")
