...
# =============================================================================
# Heartbeat Tests (POST /api/users/{user_id}/activity/heartbeat)
# =============================================================================

class TestHeartbeat:
    """Test heartbeat endpoint"""

    def test_send_heartbeat_success(self, client, mock_db, mock_user_activity):
    ...
    def test_send_heartbeat_with_optional_fields(self, client, mock_db, mock_user_activity):
    ...
    def test_send_heartbeat_creates_session(self, client, mock_db, mock_user_activity):
    ...
    def test_send_heartbeat_exception_handled(self, client, mock_db):
...
# =============================================================================
# User State Tests (GET /api/users/{user_id}/activity/state)
# =============================================================================

class TestUserState:
    """Test user state endpoint"""

    def test_get_user_state_online(self, client, mock_db, mock_user_activity):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.get(
                "/api/users/user_123/activity/state"
            )
    ...
    def test_get_user_state_away(self, client, mock_db, mock_user_activity):
    ...
    def test_get_user_state_offline(self, client, mock_db, mock_user_activity):
    ...
    def test_get_user_state_with_manual_override(self, client, mock_db, mock_user_activity):
    ...
    def test_get_user_state_no_existing_record(self, client, mock_db):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.get(
                "/api/users/new_user_123/activity/state"
            )
    ...
    def test_get_user_state_exception_handled(self, client, mock_db):
...
# =============================================================================
# Manual Override Tests (POST /api/users/{user_id}/activity/override)
# =============================================================================

class TestManualOverride:
    """Test manual override endpoint"""

    def test_set_manual_override_online(self, client, mock_db, mock_user_activity):
    ...
    def test_set_manual_override_away(self, client, mock_db, mock_user_activity):
    ...
    def test_set_manual_override_offline(self, client, mock_db, mock_user_activity):
    ...
    def test_set_manual_override_with_expiry(self, client, mock_db, mock_user_activity):
    ...
    def test_set_manual_override_invalid_state(self, client, mock_db):
    ...
    def test_set_manual_override_invalid_datetime_format(self, client, mock_db):
    ...
    def test_set_manual_override_exception_handled(self, client, mock_db):
...
# =============================================================================
# Clear Override Tests (DELETE /api/users/{user_id}/activity/override)
# =============================================================================

class TestClearOverride:
    """Test clear override endpoint"""

    def test_clear_manual_override_success(self, client, mock_db, mock_user_activity):
    ...
    def test_clear_manual_override_not_set(self, client, mock_db, mock_user_activity):
    ...
    def test_clear_manual_override_user_not_found(self, client, mock_db):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.delete(
                "/api/users/nonexistent_user/activity/override"
            )

            assert response.status_code == 404

    def test_clear_manual_override_exception_handled(self, client, mock_db):
...
# =============================================================================
# Available Supervisors Tests (GET /api/users/available-supervisors)
# =============================================================================

class TestAvailableSupervisors:
    """Test available supervisors endpoint"""

    def test_get_available_supervisors_success(self, client, mock_db, mock_supervisor_info):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.get(
                "/api/users/available-supervisors"
            )
    ...
    def test_get_available_supervisors_with_category(self, client, mock_db, mock_supervisor_info):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.get(
                "/api/users/available-supervisors?category=cardiology"
            )
    ...
    def test_get_available_supervisors_no_results(self, client, mock_db):
    ...
    def test_get_available_supervisors_exception_handled(self, client, mock_db):
...
# =============================================================================
# Active Sessions Tests (GET /api/users/{user_id}/activity/sessions)
# =============================================================================

class TestActiveSessions:
    """Test active sessions endpoint"""

    def test_get_active_sessions_success(self, client, mock_db, mock_user_activity_session):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.get(
                "/api/users/user_123/activity/sessions"
            )
    ...
    def test_get_active_sessions_multiple_sessions(self, client, mock_db):
    ...
    def test_get_active_sessions_no_sessions(self, client, mock_db):
    ...
    def test_get_active_sessions_exception_handled(self, client, mock_db):
...
# =============================================================================
# Session Termination Tests (DELETE /api/users/activity/sessions/{session_token})
# =============================================================================

class TestSessionTermination:
    """Test session termination endpoint"""

    def test_terminate_session_success(self, client, mock_db):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.delete(
                "/api/users/activity/sessions/session_token_123"
            )
    ...
    def test_terminate_session_not_found(self, client, mock_db):
        ...
        with patch('api.user_activity_routes.UserActivityService') as mock_service_class:
            ...
            response = client.delete(
                "/api/users/activity/sessions/nonexistent_session"
            )

            assert response.status_code == 404

    def test_terminate_session_exception_handled(self, client, mock_db):
...
class TestStateTransitions:
    ...
    def test_state_transition_offline_to_away(self, client, mock_db, mock_user_activity):
    ...
    def test_state_transition_away_to_online(self, client, mock_db, mock_user_activity):
...
class TestConcurrency:
    ...
    def test_multiple_sessions_same_user(self, client, mock_db):
