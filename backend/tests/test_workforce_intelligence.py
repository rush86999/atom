...
class TestWorkforceIntelligence(unittest.TestCase):
    def setUp(self):
        ...
        self.u1 = User(id="u_expert", email="expert@corp.com", first_name="Alice", last_name="Expert", role="member", status="active")
        self.u1.skills = "Python, AI"
        self.u2 = User(id="u_loader", email="loader@corp.com", first_name="Bob", last_name="Loader", role="member", status="active")
        self.u2.skills = "Java"
