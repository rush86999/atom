...
// Postgraphile GraphQL Configuration
// These must be set in the environment for Postgraphile GraphQL communication
export const POSTGRAPHILE_URL =
  process.env.POSTGRAPHILE_URL || "http://localhost:5000/graphql";
export const POSTGRAPHILE_JWT_SECRET =
  process.env.POSTGRAPHILE_JWT_SECRET || "";
export const POSTGRES_CONNECTION_STRING =
  process.env.POSTGRES_CONNECTION_STRING || "postgres://localhost/atom_db";
