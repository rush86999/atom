...
// Updated to include Chat Interface Commands
...
// **NEW: Import Atom Agent Chat Commands**
...
// Create main invoke handler with all commands including Asana and Chat
#[tauri::command]
async fn atom_invoke_command(
    ...
    match command.as_str() {
        ...
        atom_agent_commands::process_atom_agent_message(app_handle.clone(), params),
        ...
        "open_file_dialog" => {
            match params {
                Some(dialog_params) => {
                    ...
                    let filters = dialog_params.get("filters");
        ...
        // Settings commands
        "open_chat_settings" => {
            // Open chat settings window or panel
            Ok(json!({
                "success": true,
