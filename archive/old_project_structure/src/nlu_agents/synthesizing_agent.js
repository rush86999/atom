...
class SynthesizingAgent {
    constructor(llmService) {
        this.agentName = 'SynthesizingAgent';
        this.llmService = llmService;
    }
    constructPrompt(input, analytical, creative, practical, socialMedia, contentCreation, personalizedShopping, recruitmentRecommendation, vibeHacking, tax, marketingAutomation, trading) {
        const systemMessage = `
...
`;
    ...
    async synthesize(input, analytical, creative, practical, socialMedia, contentCreation, personalizedShopping, recruitmentRecommendation, vibeHacking, tax, marketingAutomation, trading) {
        const structuredPrompt = this.constructPrompt(input, analytical, creative, practical, socialMedia, contentCreation, personalizedShopping, recruitmentRecommendation, vibeHacking, tax, marketingAutomation, trading);
...
//# sourceMappingURL=synthesizing_agent.js.map