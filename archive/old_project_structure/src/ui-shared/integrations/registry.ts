...
export const ATOM_INTEGRATIONS = [
  ...
  },
  {
    id: 'plaid',
    name: 'Plaid',
    description: 'Financial services integration for banking, transactions, and payment automation',
    ...
    webhooks: [
      ...
      'holdings.updated',
      'investments_transactions.updated',
      'liabilities_updated',
    ],
    limits: {
      max_accounts: 1000,
      ...
      webhook_rate_limit: 25_per_minute,
    },
    skills: [
      'plaid_get_accounts',
      'plaid_get_transactions',
      'plaid_generate_spending_analytics',
      'plaid_sync_with_atom_memory',
    ],
    components: [
      'PlaidManager',
      'PlaidIntegration',
    ...
    dependencies: {
      ...
      'atom_ingestion_pipeline': 'Required for financial data processing',
      'fernet_encryption': 'Required for secure financial data',
    },
    supported_banks: 12000,
    supported_countries: ['US', 'CA', 'UK', 'IE', 'FR', 'DE', 'ES', 'NL', 'IT'],
    supported_institutions: [
      'chase', 'bank_of_america', 'wells_fargo', 'citibank', 'capital_one',
      'ally', 'us_bank', 'pnc', 'goldman_sachs', 'charles_schwab'
    ],
    compliance: ['PCI_DSS', 'SOC_2', 'GDPR', 'CCPA'],
  ...
  // Productivity & Enterprise Integration
  {
    ...
    limits: {
      max_teams: 1000,
      max_users: 50000,
      max_documents_per_site: 500000,
      api_calls_per_minute: 10000,
      storage_capacity: '25TB_per_user',
    },
    skills: [
    ...
    components: [
      ...
      'OneDriveManager',
      'SharePointManager',
      'PowerPlatformManager',
    ],
    dependencies: {
      'microsoft_graph_api': 'Required for Microsoft 365 API access',
      'microsoft_graph_auth': 'Required for Microsoft authentication',
      'atom_ingestion_pipeline': 'Required for data processing',
    },
    supported_services: [
      'Microsoft Teams',
      'Microsoft Outlook',
  ...
  // Legal & Document Automation
  {
    id: 'docusign',
    name: 'DocuSign',
    description: 'Complete e-signature and document automation platform for ATOM with enterprise-grade security and compliance',
    category: 'legal_automation',
    platform: 'enterprise',
    status: 'complete',
    features: [
    ...
    dependencies: {
      'docusign_api_client': 'Required for DocuSign API access',
      'microsoft_graph_auth': 'Required for OAuth authentication',
      'atom_ingestion_pipeline': 'Required for document processing',
    },
    supported_file_types: [
      'application/pdf',
      'application/msword',
  ...
  // HR Management Integrations
  {
    id: 'greenhouse',
    name: 'Greenhouse',
    description: 'Complete recruitment automation and talent management platform with enterprise HR features',
    ...
    limits: {
      ...
      max_candidates_per_month: 50000,
      max_interviews_per_month: 10000,
      max_offers_per_month: 5000,
      api_calls_per_minute: 1000,
      api_calls_per_hour: 30000,
      ...
      max_offices: 200,
      max_custom_fields: 100,
      max_scorecard_templates: 200,
      max_interview_kits: 100,
      max_email_sends_per_day: 10000,
      max_sms_sends_per_day: 1000,
      max_bulk_requests: 1000,
      max_export_items_per_request: 10000,
      max_import_items_per_request: 100000,
      max_history_retention_days: 730,
      max_audit_log_retention_days: 180,
      max_concurrent_workflows: 1000,
      max_report_generation_per_hour: 100,
      max_api_requests_per_second: 50,
      max_webhooks_per_account: 100,
      max_scheduled_interviews_per_day: 1000,
      max_document_pages: 1000,
      max_email_template_length: 100000,
      max_sms_template_length: 1000,
      max_concurrent_interviews: 5000,
      max_concurrent_email_sends: 100
    },
    skills: [
      'greenhouse_get_jobs',
      'greenhouse_post_job',
    ...
    dependencies: {
      'greenhouse_harvest_api': 'Required for Greenhouse API access',
      'greenhouse_jobs_api': 'Required for job management',
      'atom_ingestion_pipeline': 'Required for HR data processing',
      'fernet_encryption': 'Required for secure candidate data',
      'hr_analytics_engine': 'Required for hiring analytics'
    },
    supported_file_types: [
      'application/pdf',
      'application/msword',
    ...
    workflow_automation: [
      ...
      'background_check_workflows',
      'contract_generation_workflows',
      'data_sync_workflows'
    ]
  },
  // Web Analytics Integrations
  {
    ...
    description: 'Complete web analytics and marketing measurement platform with enterprise analytics features',
    category: 'analytics',
    platform: 'enterprise',
    status: 'complete',
    features: [
    ...
    webhooks: [
      ...
      'measurement_protocol_secret_created',
      'measurement_protocol_secret_deleted',
      'property.created',
      'property.updated',
      'property.deleted',
      'data_stream.created',
      ...
      'conversion_event.updated',
      'conversion_event.deleted',
      'custom_dimension.created',
      'custom_dimension.updated',
      'custom_dimension.deleted',
      'custom_metric.created',
      'custom_metric.updated',
      'custom_metric.deleted',
      'funnel_analysis.created',
      'funnel_analysis.updated',
      'funnel_analysis.deleted'
    ],
    limits: {
      max_properties_per_account: 50,
      max_data_streams_per_property: 50,
      max_views_per_property: 100,
      max_audiences_per_property: 500,
      max_conversion_events_per_property: 50,
      max_custom_dimensions_per_property: 100,
      max_custom_metrics_per_property: 100,
      max_funnel_analyses_per_property: 50,
      api_requests_per_project_per_day: 100000,
      api_requests_per_project_per_hour: 25000,
      api_requests_per_project_per_minute: 1200,
      realtime_requests_per_property_per_minute: 60,
      realtime_users_per_property_per_minute: 1000000,
      data_retention_days: 14,
      unsampled_reports_per_day: 100,
      report_rows_per_request: 100000,
      batch_filter_requests_per_project_per_day: 1000,
      filter_expressions_per_request: 1000,
      max_date_range_days: 365,
      max_segments_per_report: 10,
      max_dimensions_per_report: 9,
      max_metrics_per_report: 10,
      max_order_by_per_report: 10,
      max_search_results: 10000,
      max_webhooks_per_property: 50,
      max_daily_event_volume: 1000000000,
      max_monthly_event_volume: 25000000000,
      max_session_timeout_minutes: 240,
      max_user_id_length: 256,
      max_event_name_length: 40,
      max_dimension_name_length: 42,
      max_metric_name_length: 42,
      max_parameter_name_length: 42,
      max_page_location_length: 1000,
      max_custom_parameter_values_per_event: 25,
      max_audience_membership_duration_days: 540,
      max_report_processing_time_minutes: 5,
      max_concurrent_reports_per_property: 25,
      max_file_export_size: 1,
      max_data_seats_per_property: 10000,
      max_bigquery_exports_per_day: 100,
      max_adword_links_per_property: 5,
      max_search_ads_360_links_per_property: 5,
      max_display_video_360_links_per_property: 5,
      max_optimize_links_per_property: 5,
      max_surveys_links_per_property: 10,
      max_career_manager_links_per_property: 10,
      max_campaign_manager_360_links_per_property: 5
    },
    skills: [
    ...
    dependencies: {
      'google_analytics_data_api': 'Required for analytics data access',
      'google_analytics_admin_api': 'Required for property and configuration management',
      'google_analytics_measurement_protocol': 'Required for event tracking',
      'atom_ingestion_pipeline': 'Required for analytics data processing',
      'data_processing_engine': 'Required for analytics computation',
      'ml_prediction_service': 'Required for predictive analytics'
    },
    supported_file_types: [
      'application/json',
      'text/csv',
    ...
    integration_capabilities: [
      ...
      'google_tag_manager_integration',
      'firebase_integration',
      'google_optimize_integration',
      'youtube_analytics_integration',
      'google_play_integration',
      'app_store_integration',
      'adobe_analytics_integration',
    ...
    workflow_automation: [
      'automated_report_workflows',
      'alert_notification_workflows',
      'data_export_workflows',
      'audience_segmentation_workflows',
      'conversion_tracking_workflows',
      'ecommerce_tracking_workflows',
      'marketing_campaign_workflows',
      'compliance_monitoring_workflows',
      'data_sync_workflows',
      'performance_monitoring_workflows',
      'anomaly_detection_workflows',
      'predictive_analytics_workflows',
      'attribution_modeling_workflows',
      'real_time_monitoring_workflows',
      'custom_report_workflows',
      'data_retention_workflows',
      'privacy_compliance_workflows'
    ]
  }
];
